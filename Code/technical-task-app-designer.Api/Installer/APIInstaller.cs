...
using ElmahCore.Mvc;
using ElmahCore;
using technical-task-app-designer.Api.Filters;
using technical-task-app-designer.Business.Installer;

namespace technical-task-app-designer.Api.Installer
{
    public class APIInstaller
    {
        ...
        public void Install()
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "technical-task-app-designer API", Version = version + "-" + branch});
            });
